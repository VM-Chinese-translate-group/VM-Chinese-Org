---
title: 太阳守卫者2：搁浅汉化下载
icon: /imgs/maps/sun-guardian2.webp
description: |
...
links:
  - id: curseforge
    text: 下载地图
    link: https://www.curseforge.com/minecraft/worlds/sun-guardian-2-stranded-ctm-map/files/all
  - id: planetminecraft
    text: 地图原帖
    link: https://www.planetminecraft.com/project/sun-guardian-2-stranded/
  - id: bilibili
    text: 宣传片
...
来自备受好评的地图制作者 **SwarmOfBears** —— 热门冒险地图《太阳守卫者》的创作者——一场令人难以忘怀的冒险即将展开，它融合了**CTM**、**艾尔登法环**以及**马里奥高尔夫：家庭巡回赛**的精髓。
...
本项目汉化由 **WhiterHJ** 负责，在 [Paratranz 平台](https://paratranz.cn/projects/15705)进行协作翻译。
