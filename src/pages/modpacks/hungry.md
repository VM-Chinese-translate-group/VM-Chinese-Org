---
title: 渴望科技2汉化下载
originalName: 'Hungry for Tech 2'
icon: https://media.forgecdn.net/avatars/thumbnails/1061/916/64/64/638594251476755622.png
description: |
  这是一个半专家级的整合包，专注于通过不同的技术阶段进行进阶，例如通用机械、热力膨胀、极端反应堆、powah和龙之进化等不同阶段的科技模组的发展，以实现最终游戏目标：制作创造物品并最终制作一个三明治。
updateDate: 2024-9-1
status:
  type: stopped
compatibility:
...
links:
  - id: bilibili
    text: 专栏介绍
    link: https://www.bilibili.com/read/cv37971713
  - id: modrinth
    text: 下载i18n模组
