...
export default defineConfig({
  ...
  shortcuts: {
    ...
    'feedback-field':
      'appearance-none! [-webkit-appearance:none!important] [box-shadow:none!important] [background-image:none!important] box-border w-full min-h-11 px-3 py-2.5 text-[var(--text-dark)] font-inherit bg-[var(--bg-white)]! border border-solid! border-[color-mix(in_srgb,var(--switcher-border)_86%,transparent)]! rounded-[10px]! transition-[border-color,background-color] duration-[160ms] ease-out placeholder:text-[var(--text-muted)] hover:border-[color-mix(in_srgb,var(--info-1)_55%,var(--switcher-border))]! focus-visible:border-[var(--info-1)]! focus-visible:outline-2 focus-visible:outline-[var(--info-1)] focus-visible:outline-offset-2 focus-visible:[box-shadow:none!important] invalid:[box-shadow:none!important] invalid:border-[color-mix(in_srgb,var(--switcher-border)_86%,transparent)]!',
